			...
			<form action="" method="post" enctype="multipart/form-data">
				<table class="table table-bordered table-hover">
					...
					<tr>
						...
						<td>
							<select class="form-control" name="u_division">
								<option><?php echo $user_division ; ?></option>
								<option>Dhaka</option>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											"method="post"
											id="f">
											<strong>What is  Best Friend Name ?</strong>
										...
										if(isset($_POST['sub'])){
											...
											if($bfn ==''){
												...
												if($run){
													...
													echo "<script>window.open('edit_profile.php?u_id$user_id','_self')</script>";
												}else{echo "<script>alert('Error while updating information')</script>";
													echo "<script>window.open('edit_profile.php?u_id$user_id','_self')</script>";
												}
											}
										}
...
if (isset($_POST['update'])){
	...
	$u_division = htmlentities($_POST['u_division']);
	$u_gender = htmlentities($_POST['u_gender']);
	$u_birthday = htmlentities($_POST['u_birthday']);

	$update = "update users set f_name= '$f_name',l_name='$l_name',user_name='$u_name',describe_user='$describe_user',Relationship='$Relationship_status',user_pass='$u_pass',user_email='$u_email',user_division='$user_division',user_gender='$u_gender',user_birthday='$u_birthday' where user_id ='$user_id'";
	$run =mysqli_query($con,$update);
	      if($run){
