...
<img class='img-circle' src='users/$user_image' width='90px' height='80px'title='$user_name'><strong>&nbsp
$first_name $last_name</strong><br><br>
...
if (isset($_GET['u_id'])){
  ...
  echo '
   ...
   <form>
    ...
    <input type="submit" name="btn btn-default" disabled value="Send">
   </form><br><br>
...
echo "
 <div class='row'>
  ...
  <center>
    ...
    <li class='list-group-item' title='Division'>$user_division</li>
