...
?>
    ...
    <div class="hd">Titash, Bangladesh </div>
            ...
            <div class="card-content">
                <div class="card-body"> <img class="img" src="https://i.imgur.com/S7FJza5.png" />
                    ...
                    <div class="card-subtitle">
                        <p> <small class="text-muted"> Call in our govt 24 hours active call centre for your inquery and for gass supply problems .</small> </p>
                        <a href="dhaka.php">Helpline </a>
                    </div>
                </div>
            </div>
        </div>
        <div class="card col-md-3 col-12 ml-2">
            <div class="card-content">
                <div class="card-body"> <img class="img" src="https://i.imgur.com/xUWJuHB.png" />
                    ...
                    <div class="card-subtitle">
                        <p> <small class="text-muted">If Your area is facing any natural gass supply problems then give us report    </small> </p>
