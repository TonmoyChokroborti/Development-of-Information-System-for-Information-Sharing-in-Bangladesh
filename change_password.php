...
<div class="row">
	<div class="col-sm-12">
		<div class="well">
			<center><h1 style="color: white;"><strong>Developing Bangladesh</strong></h1></center>
		</div>
	</div>
</div>
<div class="row">
				...
				<div class="l_pass">
					<form action="" method="post">
						<div class="input-group">
							...
							name ="pass"placeholder="New Password" required>		
						</div><br>
						
						
						<div class="input-group">
							<span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
							<input id="Password" type="Password" name="pass1"required
