...
<div class="row">
	<div class="col-sm-12">
		<div class="well">
			<center><h1 style="color: white;">Develop Bangladesh</h1></center>
		</div>
	</div>
</div>
<div class="row">
	<div class="col-sm-12">
		<div class="main-content">
			<div class="header">
				<h3 style="text-align: center;"><strong>Join Develop Bangladesh</strong></h3>
				<hr>
			</div>
			<div class="l-part">
				<form action="" method="post">
					...
					<div class="input-group">
						...
						<select class="form-control" name="u_country" required="required">
							<option disabled>Select your Division</option>
							<option>Dhaka</option>
