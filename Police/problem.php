...
<div class="row">
	<div class="col-sm-12">
		<div class="main-content">
			<div class="header">
				<h3 style="text-align: center;"><strong>Bangladesh Police Complaint box</strong></h3>
				<hr>
			</div>
			<div class="l-part">
               ...
               <textarea class="form-control" placeholder=" Proposed Solution " rows="8" name="solution" id="comment" required="required">
					...
					<div class="input-group">
						...
						<input type="text" class="form-control input-md" placeholder="Thana" name="address" required="required">
					</div><br>
