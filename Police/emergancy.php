...
?>
    ...
    <div class="hd">Bangladesh Police </div>
            ...
            <div class="card-content">
                <div class="card-body"> <img class="img" src="https://i.imgur.com/S7FJza5.png" />
                    ...
                    <div class="card-subtitle">
                        <p> <small class="text-muted"> Call in our govt 24 hours active call centre for your inquery and for police security issues.</small> </p>
                        <a href="index.php">Helpline </a>
                    </div>
                </div>
            </div>
        </div>
        <div class="card col-md-3 col-12 ml-2">
            <div class="card-content">
                <div class="card-body"> <img class="img" src="https://i.imgur.com/xUWJuHB.png" />
                    <div class="card-title">Report File  </div>
                    <div class="card-subtitle">
                        <p> <small class="text-muted">If You and your  area is facing any security issues feel free to call us    </small> </p>
                        <a href="problem.php">Report </a>
                    </div>
                </div>
            </div>
        </div>
