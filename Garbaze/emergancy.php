...
?>
    ...
    <div class="hd">City Corporation , Bangladesh </div>
            ...
            <div class="card-content">
                <div class="card-body"> <img class="img" src="https://i.imgur.com/xUWJuHB.png" />
                    ...
                    <div class="card-subtitle">
                        <p> <small class="text-muted">If Your area is facing any waste snd garbaze problems then free free to call us   </small> </p>
        ...
        <div class="card col-md-3 col-12 ml-2">
            <div class="card-content">
                <div class="card-body"> <img class="img rck" src="https://i.imgur.com/rG3CGn3.png" />
                    ...
                    <div class="card-subtitle">
                        <p> <small class="text-muted"> You can submit  report about your locality's  waste management problem  </small> </p>
