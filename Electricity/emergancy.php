...
?>
    ...
    <div class="hd">Electricity Solution, Bangladesh </div>
        ...
        <div class="card col-md-3 col-12">
            <div class="card-content">
                <div class="card-body"> <img class="img" src="https://i.imgur.com/S7FJza5.png" />
                    ...
                    <div class="card-title"> Call Centre </div>
                    <div class="card-subtitle">
                        <p> <small class="text-muted"> Call in our govt 24 hours active call centre for your inquery and for electrical problems .</small> </p>
                        <a href="index2.php">Helpline </a>
                    </div>
                </div>
            </div>
        </div>
        <div class="card col-md-3 col-12 ml-2">
            <div class="card-content">
                <div class="card-body"> <img class="img" src="https://i.imgur.com/xUWJuHB.png" />
                    <div class="card-title">Complaint Box  </div>
                    <div class="card-subtitle">
                        <p> <small class="text-muted">If Your area is facing any loadsheding problems and electricty damages the get your emergency services   </small> </p>
                        <a href="problem.php">Complaint </a>
                    </div>
                </div>
            </div>
        </div>
        <div class="card col-md-3 col-12 ml-2">
            <div class="card-content">
                <div class="card-body"> <img class="img rck" src="https://i.imgur.com/rG3CGn3.png" />
                    <div class="card-title"> New Connection </div>
                    <div class="card-subtitle">
                        <p> <small class="text-muted"> If you want new elctric connection for your new house ,office ,organization you can register from here  </small> </p>
